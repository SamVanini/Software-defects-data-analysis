...
if df_raw is not None and df_clean is not None and df is not None:
    ...
    **Two-stage cleaning pipeline:**
    ...
    st.header("Dataframe should not be None")
    st.markdown("""
    Please check the data folder and the format of the input file
    """)